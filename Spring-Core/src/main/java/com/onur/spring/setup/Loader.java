...
public class Loader {
    ...
    public static void loadUsers(){
        ...
        Event eventAvengers = eventService.getByName("Avengers");
        Event eventLoveStory = eventService.getByName("Love Story");
        Event eventFamilyMan = eventService.getByName("Family Man");
