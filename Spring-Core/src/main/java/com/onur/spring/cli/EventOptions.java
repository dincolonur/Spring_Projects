...
public class EventOptions {
    ...
    public static void eventMenuOperations(Scanner in){
        printEventOptions();
        ...
        switch (eventInput){
            ...
            case "2":
                ...
                Event event = App.eventService.getByName(eventName);
                if (event != null){
            ...
            case "3":
                ...
                if (eventID.matches("[0-9]+")){
                    event = App.eventService.getById(Long.parseLong(eventID));
                    if (event != null){
                        System.out.println(event);
                    } else {
                        System.out.println("Event is not registered...");
            ...
            case "4":
                ...
                if (removeEventID.matches("[0-9]+")){
                    event = App.eventService.getById(Long.parseLong(removeEventID));
                    if (event != null){
                        if (App.eventService.remove(event)){
            ...
            case "5":
                ...
                if (newEventID.matches("[0-9]+")){
                    ...
                    for (String info : newEventAirInfos){
                        ...
                        Auditorium auditorium = App.auditoriumService.getByName(details[0]);
                    ...
                    if (App.eventService.save(newEvent)){
